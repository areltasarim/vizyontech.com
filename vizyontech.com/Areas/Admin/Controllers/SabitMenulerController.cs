...
namespace vizyontech.com.Areas.Admin.Controllers
{
    ...
    public class SabitMenulerController : Controller
    {
        SabitMenulerServis _sabitMenuServis = null;
        private readonly AppDbContext _context;
        private readonly string entityBaslik = "Sabit Menuüler";
        private readonly string entityAltBaslik = "Sabit Menü Ekle";
        public SabitMenulerController(AppDbContext _context)
        {
            this._context = _context;
            _sabitMenuServis = new SabitMenulerServis(_context);
        }
        ...
        public IActionResult AddOrUpdate(int Id = 0)
        {
            ...
            var model = _context.SabitMenuler.Find(Id);
        ...
        [HttpPost]
        public async Task<IActionResult> AddOrUpdate(SabitMenuViewModel Model, string submit)
        {
        ...
        public async Task<IActionResult> Delete(SabitMenuViewModel Model)
        {
